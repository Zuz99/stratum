...
// Coinbase ASCII tag (set via STRATUM:coinbase_tag)
extern char g_coinbase_tag[128];
...
// Vardiff (shares per minute)
extern double g_vardiff_target_spm;
extern int g_vardiff_retarget_ms;
extern double g_vardiff_variance;
extern double g_vardiff_min_factor;
extern double g_vardiff_max_factor;
extern int g_vardiff_idle_ms;
