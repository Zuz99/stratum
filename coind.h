...
//	bool closing;
	...
	// Aux work polling throttle (ms timestamp, used for merged mining refresh)
	long long last_auxpoll_time;
	...
	bool usesegwit;
	bool usemweb; // request GBT rules: segwit+mweb (litecoin mweb)
	char commitment[128];
